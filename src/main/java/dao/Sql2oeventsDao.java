...
//);
    ...
    public void add(Events events) {
        String sql = "INSERT INTO events_table (event_name,event_description,event_date,event_location,event_poster,event_startTime,event_endTime,category_type) VALUES (:event_name,:event_description,:event_date,:event_location,:event_poster,:event_startTime,:event_endTime,:category_type)";
        try (Connection con = sql2o.open()) {
...
//    private BufferedImage eventPoster;
    ...
    @Override
    public void update(int id, String eventName, String eventLocation, Date eventDate, LocalTime startTime,LocalTime endTime,int price, BufferedImage eventPoster) {
